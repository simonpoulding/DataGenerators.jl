...
#
# function isconsistentbernoulli(s::DataGenerators.Sampler, params::Vector{Float64}; support=(0,1), samplesize=100)
# 	aparams = copy(params)
# 	cc = dummyChoiceContext()
# 	xs = map(i->first(DataGenerators.sample(s, support, cc)), 1:samplesize)
# 	ys = rand(Distributions.Bernoulli(aparams[1]), samplesize)
# 	pvalue(MannWhitneyUTest(xs,ys)) > 0.0001
# end
#
# function isconsistentcategorical(s::DataGenerators.Sampler, params::Vector{Float64}; support=(0,1), samplesize=100)
...
# end
#
# function isconsistentdiscreteuniform(s::DataGenerators.Sampler, params::Vector{Float64}; support=(0,1), samplesize=100)
...
# end
#
# function isconsistentgeometric(s::DataGenerators.Sampler, params::Vector{Float64}; support=(0,1), samplesize=100)
...
# end
#
# function isconsistentnormal(s::DataGenerators.Sampler, params::Vector{Float64}; support=(0,1), samplesize=100)
...
# end
#
# function isconsistenttruncatednormal(s::DataGenerators.Sampler, params::Vector{Float64}; support=(0,1), samplesize=100)
...
# end
#
# function isconsistentuniform(s::DataGenerators.Sampler, params::Vector{Float64}; support=(0,1), samplesize=100)
# 	aparams = [minimum(params), maximum(params)]
