...
@testset "non-default choice model" begin
...
@testset "sequence are no longer than the default limit" begin
    exc = nothing
    td = nothing
    try
...
@testset "sequence are no longer than the specified limit" begin
    exc = nothing
    td = nothing
    try
